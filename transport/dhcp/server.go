...
type Transport struct {
	...
	autoInterface     bool
	interfaceCallback *list.Element[tun.NetworkUpdateCallback]
...
func (t *Transport) Start() error {
	...
	if t.autoInterface {
		t.interfaceCallback = t.router.NetworkMonitor().RegisterCallback(t.fetchServers)
	}
	return nil
}
...
func (t *Transport) Close() error {
	if t.interfaceCallback != nil {
		t.router.NetworkMonitor().UnregisterCallback(t.interfaceCallback)
	}
	return nil
}
